...
public record Placa
{
    ...
    private static bool EhValida(string placa)
    {
        ...
        var formatoAntigo = placa.Take(3).All(char.IsLetter) &&
                           placa.Skip(3).All(char.IsDigit);

        // Formato Mercosul: AAA9A99
        var formatoMercosul = placa.Take(3).All(char.IsLetter) &&
    ...
    public bool EhFormatoMercosul() =>
        Valor.Length == 7 && char.IsLetter(Valor[4]);
